 ...
 */
class getMessenger_Transport_CoursesTransportService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['messenger.transport.courses_transport'])) {
            return $container->privates['messenger.transport.courses_transport'];
        }

        return $container->privates['messenger.transport.courses_transport'] = $a->createTransport($container->getEnv('MESSENGER_TRANSPORT_DSN'), ['exchange' => ['name' => 'courses_exchange', 'type' => 'direct'], 'queues' => ['python_courses' => ['binding_keys' => ['course.python', 'course.both']], 'webdev_courses' => ['binding_keys' => ['course.webdev', 'course.both']]], 'transport_name' => 'courses_transport'], ($container->privates['messenger.transport.native_php_serializer'] ??= new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer()));
    }
}
